...
class LObservation:
    ...
    def __init__ (self, lunar_day = 2500, lun_lat_deg = -10., lun_long_deg = 180.,
                  lun_height_m = 0,  deltaT_sec = 15*60):
        ...
        self.loc = lunarsky.MoonLocation.from_selenodetic(lon = lun_long_deg,
                                                          lat = lun_lat_deg, heigh = lun_height_m)
