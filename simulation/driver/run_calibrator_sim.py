...
from calibrator_sim_driver import CalibratorSimDriver
...
@hydra.main(version_base=None, config_path=_CONFIG_PATH, config_name="calibrator_example")
def run(cfg: DictConfig):
    resolved = OmegaConf.to_container(cfg, resolve=True)
    S = CalibratorSimDriver(resolved)
    S.run()
