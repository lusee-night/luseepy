...
export ROOT=$LUSEE_DRIVE_DIR/AntennaResponse/SimulationFiles/ShortDipoleComparison/dipole_in_vacuum/feko_bnl/20220406_short_dipole_5mm/dipole_test_5mm_sep
export OUT=$LUSEE_DRIVE_DIR/AntennaResponse/Exported/ShortDipoleComparison/dipole_in_vacuum/feko_bnl_short_dipole_5mm.fits
